...
# 默认使用清华镜像源，其他环境可在 docker compose build 时通过 build args 覆盖。
ARG DEBIAN_MIRROR=mirrors.tuna.tsinghua.edu.cn
ARG DEBIAN_SECURITY_MIRROR=mirrors.tuna.tsinghua.edu.cn
ARG GEM_SOURCE=https://mirrors.tuna.tsinghua.edu.cn/rubygems/
...
# Gemfile / Gemfile.lock 在仓库中默认指向清华源；覆盖源时只改容器内副本。
RUN sed -i "s#https://gems.ruby-china.com/#${GEM_SOURCE}#g; s#https://mirrors.tuna.tsinghua.edu.cn/rubygems/#${GEM_SOURCE}#g; s#https://rubygems.org/#${GEM_SOURCE}#g" Gemfile Gemfile.lock
