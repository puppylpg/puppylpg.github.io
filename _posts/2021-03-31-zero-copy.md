---
title: "零拷贝：read/write、mmap 与 sendfile 的数据路径"
date: 2021-03-31 00:29:23 +0800
categories: [tech, io]
tags: [io, zero-copy, mmap, sendfile, dma]
description: "从文件原样传输的场景出发，对比 read/write、mmap + write 与 sendfile 的数据路径，解释零拷贝省掉了哪些 CPU 复制。"
---
