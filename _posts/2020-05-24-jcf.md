...
tags: [java, jcf, guava]
description: "按接口层级梳理 Java Collection Framework，说明 List、Set、Queue、Map 与常见实现的适用场景。"
---
...
# 接口
![JCF Collection Interface](/pics/java/jcf-interface.png)
图片来源：[CarpenterLee/JCFInternals](https://github.com/CarpenterLee/JCFInternals/blob/master/PNGFigures/JCF_Collection_Interfaces.png)。
