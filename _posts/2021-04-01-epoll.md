...
tags: [nio, linux]
description: "从进程阻塞、select 轮询到 epoll 就绪队列，理解 Java NIO Selector 背后的 Linux 事件通知机制。"
---
...
Ref:
- [Java Thread.State 文档](https://docs.oracle.com/javase/8/docs/api/java/lang/Thread.State.html)
...
Ref：
- [一个关于进程阻塞和 epoll 的通俗解释](https://zhuanlan.zhihu.com/p/63179839)
...
Ref：
- [Linux I/O multiplexing: select vs poll vs epoll](https://devarea.com/linux-io-multiplexing-select-vs-poll-vs-epoll/)
...
## select vs. epoll
Ref:
- [select、poll、epoll 对比](https://www.jianshu.com/p/31cdfd6f5a48)
