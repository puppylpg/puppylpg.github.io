...
tags: [java, time]
description: "梳理 java.time 中人类时间、机器时间、时区时间和 Temporal 计算模型的区别与转换。"
---
...
- [Oracle Java Tutorial: Date Time](https://docs.oracle.com/javase/tutorial/datetime/iso/index.html)
- [Oracle Java Tutorial: Overview](https://docs.oracle.com/javase/tutorial/datetime/iso/overview.html)
- [JSR-310 guide](https://jcp.org/aboutJava/communityprocess/pfd/jsr310/JSR-310-guide.html)

```mermaid
flowchart TD
    Human["Human Time<br/>年月日时分秒"] --> LocalDate["LocalDate"]
    Human --> LocalTime["LocalTime"]
    Human --> LocalDateTime["LocalDateTime"]
    LocalDateTime --> ZonedDateTime["ZonedDateTime<br/>LocalDateTime + ZoneId"]
    LocalDateTime --> OffsetDateTime["OffsetDateTime<br/>LocalDateTime + ZoneOffset"]
    Machine["Machine Time<br/>epoch timeline"] --> Instant["Instant"]
    Instant <--> ZonedDateTime
    Temporal["Temporal / TemporalAmount"] --> Human

    style Human fill:#e3f2fd,stroke:#1976d2
    style Machine fill:#fff3bf,stroke:#f59f00
    style ZonedDateTime fill:#e8f5e9,stroke:#2e7d32
```
