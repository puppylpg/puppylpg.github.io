...
categories: [java]
tags: [java]
description: "从对象头、实例数据、padding、指针压缩和 Mark Word，解释 Java 对象在 HotSpot 里的真实布局。"
---
...
block-beta
    columns 1
    block:object["Java Object"]
        columns 3
        Header["Header<br/>Mark Word + Klass Pointer"]
        Data["Instance Data<br/>字段值 / OOP 引用"]
        Padding["Padding<br/>8-byte 对齐"]
    end
    Header --> Mark["Mark Word<br/>hash / age / lock state / GC bits"]
    Header --> Klass["Klass Pointer<br/>指向类元数据"]
    Data --> Oop["Ordinary Object Pointer<br/>指向其他对象"]

    style Header fill:#e3f2fd,stroke:#1976d2
    style Data fill:#e8f5e9,stroke:#2e7d32
    style Padding fill:#fff3bf,stroke:#f59f00
```
