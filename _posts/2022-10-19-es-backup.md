...
```
[liuhaibo@th077.corp.yodao.com ~]$ /global/share/ying.huang/esdump/elasticdump --input=https://elastic:4BTk36818tLuL0ZR71ESD0bN@elasticsearch-ead-test.inner.youdao.com/witake_media --output=http://localhost:9200/witake_media --type=data --limit=1000
```
...
## 备份进度
`GET _snapshot/everyday/_current`
```
{
  "snapshots" : [
    {
...
`GET _snapshot/everyday/_status`
```
{
  "snapshots" : [
    {
