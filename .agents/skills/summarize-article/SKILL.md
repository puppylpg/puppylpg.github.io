...
- 在开头附近使用有意义的 Markdown 链接注明原始来源，然后从背景和问题张力切入。
...
- 批判性评价放在相应论点或边界第一次需要的位置；不要强制追加固定的“核心”“评价”或 FAQ 章节。
...
1. 只读标题、H2 和每节首句，未读原文的读者能否理解文章推进路径；
2. 是否仍在按原文目录、叙述时间线或问答顺序复述；
3. 每个概念是否在依赖它的内容之前出现；
4. 重要论点是否有原文证据，评价和推断是否明确区分；
5. 翻译是否自然，专业术语、公式、图和例子是否解释充分；
6. 标题、description、categories、tags、文件名和中文引号是否符合 `AGENTS.md`。
