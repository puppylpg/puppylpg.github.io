...
![3D 知识图书馆全景](/pics/3d-theme/world-overview.jpg)
_/world/ 全景：环形书架、中央纪念碑、星空与 HUD 分类导航，每个分类一种霓虹色_
...
![书架特写](/pics/3d-theme/world-shelf.jpg)
_AI 书架特写：悬停的那本书已滑出书架并发光，旁边浮出标题卡；书脊上是 canvas 实时绘制的竖排标题_

![赛博皮肤首页](/pics/3d-theme/home-cyber.jpg)
_经典首页换上赛博皮肤：玻璃拟态卡片（第二张正被鼠标 3D 倾斜）、渐变站名、发光头像、与书架同色的集合徽章，右下角是魔方传送门_

![全息阅读面板](/pics/3d-theme/post-holo.jpg)
_文章页即本文：正文是一块悬浮的玻璃面板，发光描边 + 全息扫描线，整体随鼠标转动_

![标签星球](/pics/3d-theme/tag-sphere.jpg)
_/tags/ 标签星球：最热 72 个标签组成可拖拽旋转的 3D 球，下方保留完整扁平标签云_

![迷失太空 404](/pics/3d-theme/404-space.jpg)
_404 页：故障风渐变数字，中间的 0 是纯 CSS 画的带光环土星_
